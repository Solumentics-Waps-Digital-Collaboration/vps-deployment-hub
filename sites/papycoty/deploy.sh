...
SITE_NAME="papycoty"
DOMAIN="papycoty.com"
GITHUB_REPO="https://github.com/Solumentics-Waps-Digital-Collaboration/papycopy.git"
BRANCH="main"
...
if [ ! -f "$DEPLOY_DIR/.env" ]; then
    ...
    echo "SMTP_PORT=465"
    echo "SMTP_USER=info@papycoty.com"
    echo 'SMTP_PASSWORD="Papycoty2026@#"'
    echo "CONTACT_EMAIL_TO=info@papycoty.com"
    echo "CONTACT_EMAIL_FROM=info@papycoty.com"
